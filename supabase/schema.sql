...
-- Returns jsonb (not a plain uuid) so the client can tell an instant join
-- apart from a pending request on a private group.
...
-- clause does the real narrowing" trick as group_profiles above.
